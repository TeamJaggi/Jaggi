...
class ForwardBot:
    ...
    def save_message_mapping(self, source_message_id, source_channel_id, target_message_id, target_channel_id):
        ...
        c = conn.cursor()
        try:
            c.execute("INSERT OR REPLACE INTO message_mapping (source_message_id, source_channel_id, target_message_id, target_channel_id) VALUES (?, ?, ?, ?)",
...
async def reset_all(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    c.execute("INSERT INTO settings (name, value) VALUES ('text_only', 'false')")
...
async def toggle_text_only(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    bot.set_setting('text_only', 'true' if new_status else 'false')
...
async def main():
    ...
    app.add_handler(CommandHandler("textonly", toggle_text_only))
